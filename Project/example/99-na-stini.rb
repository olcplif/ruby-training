...
def englishNumber number
  ...
  # Перевіряємо кількість трильйонів
  ...
  # Перевіряємо кількість міліардів
  ...
  # Перевіряємо кількість мільйонів
  write = left/1000000
...
while i >= 1
  if i == 1
    puts englishNumber(i).to_s + ' dollar in my pocket'
    i -= 1
  else
    puts englishNumber(i).to_s + ' dollars in my pocket'
    i -= 1
  end
end
